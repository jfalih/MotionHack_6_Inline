    ...
    return(
        <View style={{
            ...
            <ScrollView contentContainerStyle={{
                ...
                <TextInput placeholder="Nomor Handphone / Email" placeholderTextColor="#eee" style={{
                    height: 60,
                    fontSize:16,
                ...
                <TextInput placeholder="Password" placeholderTextColor="#eee" style={{
                    height: 60,
                    fontSize:16,
                    fontFamily:'Inter-Regular',
                    paddingHorizontal:15,
                ...
                <TouchableOpacity onPress={() => navigation.navigate('AuthRegister')} style={{
                    marginLeft:5
                }}>
                    <Text style={{
                        color: PRIMARY_COLOR,
